...
import type { Quench, QuenchReports } from "./quench";
 ...
 */
export declare const quenchReady: (quench: Quench) => void;
 ...
 */
export declare const quenchReports: (reports: QuenchReports) => void;
